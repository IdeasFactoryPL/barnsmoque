...
DrinkItem.create!(name: "RUM 40ml", drink_group: DrinkGroup.find_by_name("GARŚĆ DYNAMITU"), user: admin)
DrinkItem.create!(name: "GIN 40ml", drink_group: DrinkGroup.find_by_name("GARŚĆ DYNAMITU"), user: admin)
DrinkItem.create!(name: "WÓDKA 40ml", english_name: "VODKA 40ml", drink_group: DrinkGroup.find_by_name("GARŚĆ DYNAMITU"), user: admin)
DrinkItem.create!(name: "WINO DOMOWE", drink_group: DrinkGroup.find_by_name("GARŚĆ DYNAMITU"), user: admin)
